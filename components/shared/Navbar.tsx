...
import logo from './../../public//img/risidio_logo_white.svg';
...
function Navbar() {
  ...
  return (
    <Box className="px-4 sm:px-12 py-2 flex justify-between items-center bg-black">
      <nav className="flex w-full md:flex items-center justify-between h-14">
        ...
        {isOpenMenu ? (
          <Box className="bg-black h-screen md:hidden z-10 mt-16 fixed w-full left-0 top-[-0px] transition-all ease-in duration-500 flex flex-col items-center justify-evenly">
            <ul className="flex flex-col items-center md:hidden">
              <li className="text-white mx-4 my-6 md:my-0 text-2xl font-[200]">
              ...
              <li className="text-[#5fbdc1] mx-4 my-6 md:my-0 text-2xl font-medium">
        ...
        <ul className="hidden bg-black md:flex md:flex-row md:items-center md:z-auto md:static md:w-auto md:py-0 md:pl-0 md:opacity-100 md:transition-none md:mt-3">
          <li className="text-white my-0 font-navFont text-navbar pl-0 md:pr-0 hover:underline hover:text-[#5fbdc1] ml-10 font-medium text-sm">
            <Link href="/ourwork">Our work</Link>
          </li>
          <li className="text-white my-0 font-navFont text-navbar pl-0 md:pr-0 hover:underline hover:text-[#5fbdc1] ml-10 font-medium text-sm">
            <Link href="/about">About</Link>
        ...
        <Link href="/contact" className="hidden md:flex md:ml-auto">
          <div className="hidden mr-4 px-1.5 py-px text-[13px] font-bold rounded-full md:flex justify-center items-center bg-[#ffffff33] w-32 h-10 hover:bg-white">
